...
var filePath = path.resolve('src/Data/Configuration.js');
var configuration = require(filePath);


function create_and_send_invoice_immediately(user, callback) {
	try {

		

		var datos=[];
		datos.push(Object.values(user));
		...
		customerInformation.name = String(datos[0][0]);
		customerInformation.email = String(datos[0][1]);
...
module.exports = function (name, callback) {
	create_and_send_invoice_immediately(name, callback);
};
